...
class HeatDiffusionScenario(Scenario):

    def __init__(self):
        super().__init__()
        self.particle_count = 600
        self.temperature = 300
        self.temperature_hot = 1000
        self.particle_type = PARTICLE_PRESETS["H2"]
        self.lx = 10e-9
        self.dense_proportion = 1/4
    ...
    def setup_system(self):
        ...
        sim.add_particles(
            ...
            count=int(self.particle_count*self.dense_proportion),
            temperature=self.temperature_hot,
...
if __name__ == "__main__":
    scenario = HeatDiffusionScenario()
